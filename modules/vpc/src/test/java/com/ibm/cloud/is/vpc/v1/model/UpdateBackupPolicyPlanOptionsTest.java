...
/**
 * Unit test class for the UpdateBackupPolicyPlanOptions model.
 */
public class UpdateBackupPolicyPlanOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBackupPolicyPlanOptions() throws Throwable {
  ...
  public void testUpdateBackupPolicyPlanOptionsError() throws Throwable {
    new UpdateBackupPolicyPlanOptions.Builder().build();
  }

...
/**
 * Unit test class for the UpdateVpnServerOptions model.
 */
public class UpdateVpnServerOptionsTest {
  ...
  public void testUpdateVpnServerOptionsError() throws Throwable {
    new UpdateVpnServerOptions.Builder().build();
  }

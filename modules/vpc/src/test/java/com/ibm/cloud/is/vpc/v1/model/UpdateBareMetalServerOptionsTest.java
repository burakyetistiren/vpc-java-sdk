...
/**
 * Unit test class for the UpdateBareMetalServerOptions model.
 */
public class UpdateBareMetalServerOptionsTest {
  ...
  public void testUpdateBareMetalServerOptionsError() throws Throwable {
    new UpdateBareMetalServerOptions.Builder().build();
  }

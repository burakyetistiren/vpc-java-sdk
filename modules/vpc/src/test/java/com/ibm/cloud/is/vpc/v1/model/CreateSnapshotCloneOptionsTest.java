...
/**
 * Unit test class for the CreateSnapshotCloneOptions model.
 */
public class CreateSnapshotCloneOptionsTest {
  ...
  public void testCreateSnapshotCloneOptionsError() throws Throwable {
    new CreateSnapshotCloneOptions.Builder().build();
  }

...
/**
 * Unit test class for the VPNServerRoute model.
 */
public class VPNServerRouteTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNServerRoute() throws Throwable {
    VPNServerRoute vpnServerRouteModel = new VPNServerRoute();

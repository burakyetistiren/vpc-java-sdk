...
/**
 * Unit test class for the InstancePrototypeInstanceByCatalogOffering model.
 */
public class InstancePrototypeInstanceByCatalogOfferingTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstancePrototypeInstanceByCatalogOffering() throws Throwable {
    ...
    InstancePrototypeInstanceByCatalogOffering instancePrototypeInstanceByCatalogOfferingModel = new InstancePrototypeInstanceByCatalogOffering.Builder()
      ...
      .build();
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.availabilityPolicy(), instanceAvailabilityPrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.defaultTrustedProfile(), instanceDefaultTrustedProfilePrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.keys(), java.util.Arrays.asList(keyIdentityModel));
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.metadataService(), instanceMetadataServicePrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.networkInterfaces(), java.util.Arrays.asList(networkInterfacePrototypeModel));
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.placementTarget(), instancePlacementTargetPrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.profile(), instanceProfileIdentityModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.resourceGroup(), resourceGroupIdentityModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.totalVolumeBandwidth(), Long.valueOf("500"));
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.userData(), "testString");
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.volumeAttachments(), java.util.Arrays.asList(volumeAttachmentPrototypeInstanceContextModel));
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.vpc(), vpcIdentityModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.bootVolumeAttachment(), volumeAttachmentPrototypeInstanceByImageContextModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.catalogOffering(), instanceCatalogOfferingPrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.primaryNetworkInterface(), networkInterfacePrototypeModel);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.zone(), zoneIdentityModel);

    String json = TestUtilities.serialize(instancePrototypeInstanceByCatalogOfferingModel);

    InstancePrototypeInstanceByCatalogOffering instancePrototypeInstanceByCatalogOfferingModelNew = TestUtilities.deserialize(json, InstancePrototypeInstanceByCatalogOffering.class);
    assertTrue(instancePrototypeInstanceByCatalogOfferingModelNew instanceof InstancePrototypeInstanceByCatalogOffering);
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.availabilityPolicy().toString(), instanceAvailabilityPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.defaultTrustedProfile().toString(), instanceDefaultTrustedProfilePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.metadataService().toString(), instanceMetadataServicePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.placementTarget().toString(), instancePlacementTargetPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.profile().toString(), instanceProfileIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.resourceGroup().toString(), resourceGroupIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.totalVolumeBandwidth(), Long.valueOf("500"));
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.userData(), "testString");
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.vpc().toString(), vpcIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.bootVolumeAttachment().toString(), volumeAttachmentPrototypeInstanceByImageContextModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.catalogOffering().toString(), instanceCatalogOfferingPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.primaryNetworkInterface().toString(), networkInterfacePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.zone().toString(), zoneIdentityModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testInstancePrototypeInstanceByCatalogOfferingError() throws Throwable {
    new InstancePrototypeInstanceByCatalogOffering.Builder().build();
  }

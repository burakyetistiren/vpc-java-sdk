...
/**
 * Unit test class for the ListBackupPolicyPlansOptions model.
 */
public class ListBackupPolicyPlansOptionsTest {
  ...
  public void testListBackupPolicyPlansOptionsError() throws Throwable {
    new ListBackupPolicyPlansOptions.Builder().build();
  }

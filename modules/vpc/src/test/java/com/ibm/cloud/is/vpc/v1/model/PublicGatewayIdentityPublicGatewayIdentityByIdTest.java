...
/**
 * Unit test class for the PublicGatewayIdentityPublicGatewayIdentityById model.
 */
public class PublicGatewayIdentityPublicGatewayIdentityByIdTest {
  ...
  public void testPublicGatewayIdentityPublicGatewayIdentityByIdError() throws Throwable {
    new PublicGatewayIdentityPublicGatewayIdentityById.Builder().build();
  }

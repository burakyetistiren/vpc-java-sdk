...
/**
 * Unit test class for the BackupPolicyPlanReference model.
 */
public class BackupPolicyPlanReferenceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBackupPolicyPlanReference() throws Throwable {
    BackupPolicyPlanReference backupPolicyPlanReferenceModel = new BackupPolicyPlanReference();
    assertNull(backupPolicyPlanReferenceModel.getDeleted());

...
/**
 * Unit test class for the BareMetalServerDisk model.
 */
public class BareMetalServerDiskTest {
  ...
  public void testBareMetalServerDisk() throws Throwable {
    ...
    assertNull(bareMetalServerDiskModel.getInterfaceType());
    assertNull(bareMetalServerDiskModel.getName());
    assertNull(bareMetalServerDiskModel.getResourceType());
    assertNull(bareMetalServerDiskModel.getSize());
  }
}
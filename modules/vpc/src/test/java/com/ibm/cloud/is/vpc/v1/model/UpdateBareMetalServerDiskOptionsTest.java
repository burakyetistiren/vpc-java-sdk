...
/**
 * Unit test class for the UpdateBareMetalServerDiskOptions model.
 */
public class UpdateBareMetalServerDiskOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBareMetalServerDiskOptions() throws Throwable {
  ...
  public void testUpdateBareMetalServerDiskOptionsError() throws Throwable {
    new UpdateBareMetalServerDiskOptions.Builder().build();
  }

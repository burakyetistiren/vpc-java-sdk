...
/**
 * Unit test class for the RouteCreator model.
 */
public class RouteCreatorTest {
  ...
  @Test
  public void testRouteCreator() throws Throwable {
    RouteCreator routeCreatorModel = new RouteCreator();
    assertNotNull(routeCreatorModel);
  }
}
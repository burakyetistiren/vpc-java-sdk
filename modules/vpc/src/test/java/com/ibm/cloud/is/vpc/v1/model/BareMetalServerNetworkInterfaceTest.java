...
/**
 * Unit test class for the BareMetalServerNetworkInterface model.
 */
public class BareMetalServerNetworkInterfaceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testBareMetalServerNetworkInterface() throws Throwable {
    BareMetalServerNetworkInterface bareMetalServerNetworkInterfaceModel = new BareMetalServerNetworkInterface();
    assertNotNull(bareMetalServerNetworkInterfaceModel);
  }
}
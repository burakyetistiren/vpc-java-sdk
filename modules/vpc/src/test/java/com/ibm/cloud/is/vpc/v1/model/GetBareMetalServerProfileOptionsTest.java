...
/**
 * Unit test class for the GetBareMetalServerProfileOptions model.
 */
public class GetBareMetalServerProfileOptionsTest {
  ...
  public void testGetBareMetalServerProfileOptionsError() throws Throwable {
    new GetBareMetalServerProfileOptions.Builder().build();
  }

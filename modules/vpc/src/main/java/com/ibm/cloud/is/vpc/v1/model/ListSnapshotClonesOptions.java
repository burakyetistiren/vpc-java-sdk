...
/**
 * The listSnapshotClones options.
 */
public class ListSnapshotClonesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a ListSnapshotClonesOptions.
     *
     * @return the new ListSnapshotClonesOptions instance
     */
    public ListSnapshotClonesOptions build() {
      return new ListSnapshotClonesOptions(this);
    }
     ...
     *
     * @param id the id
     * @return the ListSnapshotClonesOptions builder
     */
   ...
   * New builder.
   *
   * @return a ListSnapshotClonesOptions builder
   */

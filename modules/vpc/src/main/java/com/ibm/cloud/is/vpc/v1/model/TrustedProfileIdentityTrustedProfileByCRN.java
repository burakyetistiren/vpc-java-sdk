 ...
 */
public class TrustedProfileIdentityTrustedProfileByCRN extends TrustedProfileIdentity {
  ...
  public static class Builder {
    ...
    /**
     * Builds a TrustedProfileIdentityTrustedProfileByCRN.
     *
     * @return the new TrustedProfileIdentityTrustedProfileByCRN instance
     */
    public TrustedProfileIdentityTrustedProfileByCRN build() {
      return new TrustedProfileIdentityTrustedProfileByCRN(this);
    }
     ...
     *
     * @param crn the crn
     * @return the TrustedProfileIdentityTrustedProfileByCRN builder
     */
   ...
   * New builder.
   *
   * @return a TrustedProfileIdentityTrustedProfileByCRN builder
   */

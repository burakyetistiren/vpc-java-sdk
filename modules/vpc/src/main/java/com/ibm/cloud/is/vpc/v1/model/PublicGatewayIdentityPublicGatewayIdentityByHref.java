 ...
 */
public class PublicGatewayIdentityPublicGatewayIdentityByHref extends PublicGatewayIdentity {
  ...
  public static class Builder {
    ...
    /**
     * Builds a PublicGatewayIdentityPublicGatewayIdentityByHref.
     *
     * @return the new PublicGatewayIdentityPublicGatewayIdentityByHref instance
     */
    public PublicGatewayIdentityPublicGatewayIdentityByHref build() {
      return new PublicGatewayIdentityPublicGatewayIdentityByHref(this);
    }
     ...
     *
     * @param href the href
     * @return the PublicGatewayIdentityPublicGatewayIdentityByHref builder
     */
   ...
   * New builder.
   *
   * @return a PublicGatewayIdentityPublicGatewayIdentityByHref builder
   */
